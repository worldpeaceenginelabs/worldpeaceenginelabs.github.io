/*!elementor - v3.5.6 - 28-02-2022*/"use strict";(self["webpackChunkelementor"]=self["webpackChunkelementor"]||[]).push([["text-path"],{"../modules/shapes/assets/js/frontend/handlers/text-path.js":/*!******************************************************************!*\
...
setText(newText){var _this$getElementSetti;const{url,is_external:isExternal,nofollow}=(_this$getElementSetti=this.getElementSettings())===null||_this$getElementSetti===void 0?void 0:_this$getElementSetti.link;const target=isExternal?'_blank':'',rel=nofollow?'nofollow':'';if(url){newText=`<a href="${(0,_utils.escapeHTML)(url)}" rel="${rel}" target="${target}">${(0,_utils.escapeHTML)(newText)}</a>`;}

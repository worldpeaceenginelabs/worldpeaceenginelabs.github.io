import{tints,darkTints,heading,lineHeight,fontWeight,spacing}from 'e-styles';export default{base:{shared:`
		...
		`,variant:{h1:`
			...
			`,'display-4':`
				...
				--e-styles-heading-margin-bottom: ${ spacing.base };
				margin-top: ${ spacing.base };
			`,},size:`--size-value: default;`,},light:{variant:{h1:`--e-styles-heading-color: ${ tints['600']};`,h2:`--e-styles-heading-color: ${ tints['600']};`,'display-3':`--e-styles-heading-color: ${ tints['600']};`,},},dark:`--e-styles-heading-color: ${ darkTints['100']};`,};